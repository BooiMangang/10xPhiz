...
const CandyMachine = ({ walletAddress }) => {
  ...
  //Fuck I don't understand what I am doing here
  useEffect(() => {
  ...
  return (
    ...
    machineStats && (
      <div className="machine-container">
        ...
        {isLive && <div className="mint_is_live"> Mint Is Live</div>}
        ...
        {machineStats.itemsRedeemed === machineStats.itemsAvailable
          ...
          : isMinting
            ? (<img alt="loading" className="loading_image" src={loading_image} />)
            : isLive &&
